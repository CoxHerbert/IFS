...
CREATE TABLE `freight_shipment_plan` (
  ...
  `order_no` varchar(64) DEFAULT '' COMMENT '客户订单号/参考号',
...
-- Dictionaries
-- ----------------------------
INSERT INTO `sys_dict_type` VALUES (200, '出货状态', 'freight_shipment_status', '0', 'admin', now(), '', NULL, '客户分享页展示状态');
INSERT INTO `sys_dict_data` VALUES (2000, 1, '计划已创建', '10', 'freight_shipment_status', '', 'primary', 'N', '0', 'admin', now(), '', NULL, '内部已建出货计划');
...
INSERT INTO `sys_dict_data` VALUES (2015, 13, '船舶已开航', '130', 'freight_shipment_status', '', 'success', 'N', '0', 'admin', now(), '', NULL, '船已开航');
INSERT INTO `sys_dict_data` VALUES (2016, 14, '目的港已到港', '140', 'freight_shipment_status', '', 'success', 'N', '0', 'admin', now(), '', NULL, '船已到目的港码头');
...
-- ----------------------------
INSERT INTO `sys_menu` VALUES (140, '货代业务', 0, 4, 'freight', NULL, 1, 0, 'M', '0', '0', '', 'international', 'admin', now(), '', NULL, '国际货代业务菜单');
INSERT INTO `sys_menu` VALUES (141, '出货计划', 140, 1, 'shipment', 'freight/shipment/index', 1, 0, 'C', '0', '0', 'freight:shipment:list', 'list', 'admin', now(), '', NULL, '出货计划管理');
INSERT INTO `sys_menu` VALUES (1160, '出货计划查询', 141, 1, '#', '', 1, 0, 'F', '0', '0', 'freight:shipment:query', '#', 'admin', now(), '', NULL, '');
INSERT INTO `sys_menu` VALUES (1161, '出货清单导入', 141, 2, '#', '', 1, 0, 'F', '0', '0', 'freight:shipment:import', '#', 'admin', now(), '', NULL, '');
INSERT INTO `sys_menu` VALUES (1162, '出货状态维护', 141, 3, '#', '', 1, 0, 'F', '0', '0', 'freight:shipment:edit', '#', 'admin', now(), '', NULL, '');
INSERT INTO `sys_menu` VALUES (1163, '生成出货单', 141, 4, '#', '', 1, 0, 'F', '0', '0', 'freight:shipment:confirm', '#', 'admin', now(), '', NULL, '');
INSERT INTO `sys_menu` VALUES (1164, '分享出货进度', 141, 5, '#', '', 1, 0, 'F', '0', '0', 'freight:shipment:share', '#', 'admin', now(), '', NULL, '');
INSERT INTO `sys_menu` VALUES (1165, '出货计划删除', 141, 6, '#', '', 1, 0, 'F', '0', '0', 'freight:shipment:remove', '#', 'admin', now(), '', NULL, '');
